...
public class TypecheckLecturaEscrituraTest {
	@Test
    void test() {
        //Programa que importa una librería y llama a una de sus funciones
        Reader input = null;
        try {
            input = new InputStreamReader(new FileInputStream("src/test/resources/bindingTypeChecking/lecturaEscritura.jaja"));
